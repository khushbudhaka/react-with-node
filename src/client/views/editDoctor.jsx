...
class editDoctor extends Component {
   ...
   componentDidMount() {
      ...
      const apiUrl = 'https://4e05b6be.ngrok.io/api/doctors/'+ doctorId;
        ...
        .then(
          (result) => {
               this.setState({ 
                ...
                doctorId: result.data[0].doctorId,
                 });
          },
          (error) => {
            this.setState({ error });
    ...
    fetch('https://4e05b6be.ngrok.io/api/doctors/'+this.state.doctorId, {
        method: 'PATCH',
        headers: new Headers({
         'Content-Type': 'application/json'
        }), 
              ...
              <Card
                ...
                content={
                  ...
                  <label className="control-label">Doctor name</label>
                   ...
                   <input type="text" className="form-control" onChange={this.handleChange} name="speciality" value={this.state.speciality}/>
